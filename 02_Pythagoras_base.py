...
def question_checker(question):
    ...
    while response not in valid_responses:
        print(
            "<error> Please enter 'p' for Pythagorean triple questions, 'm' for Multiplication Challenge questions, 's' for Square Numbers Challenge questions, or press <enter> for all types of questions.")
        response = input(question).lower()
    return response
